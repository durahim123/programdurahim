            ...
            <div class="nk-block nk-block-lg">
                ...
                <div class="card card-bordered card-preview" style="padding:30px;">
                    <div class="card-inner">
                        ...
                        <h4 class="title nk-block-title">Edit Booking</h4>
                        <div class="preview-block">
                            <form method="POST" action="{{ URL::to('do-update-booking/'.$data->id) }}">
                                @csrf
                                <div class="row gy-4">
                                @if(session('auth_user')['role'] == 'admin')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="form-control" name="pasien_id" required>
                                                    ...
                                                    <option value="{{ $value->id }}" @if($data->pasien_id == $value->id) selected @endif>{{ $value->nama_pasien }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="date" class="form-control" name="tgl_booking" placeholder="Input Harga" value="{{ $data->tgl_booking }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="time" class="form-control" name="jam_booking" placeholder="Input Harga" value="{{ $data->jam_booking }}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="form-control" name="dokter_id" id="dokter" data-dokter-ids="{{ $dokter->pluck('id')->implode(',') }}" required>
                                                    ...
                                                    <option value="{{ $value->id }}" @if($data->dokter_id == $value->id) selected @endif>{{ $value->nama_dokter }}</option>
                                                    @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select name="metode" id="" class="form-control">
                                                    ...
                                                    <option value="Cash" @if($data->metode == 'Cash') selected @endif>Cash</option>
                                                    <option value="Transfer Bank" @if($data->metode == 'Transfer Bank') selected @endif>Transfer Bank</option>
                                                    <option value="QRIS" @if($data->metode == 'QRIS') selected @endif>QRIS</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <table class="table" id="dynamic_field">
                                                @foreach ($idLayanan as $lk)
                                                <tr>
                                                    <th>
                                                        <select class="form-control" name="layanan_id[]" required>
                                                            <option value="" selected disabled>--  Pilih Layanan --</option>
                                                            @foreach($layanan as $keys => $values)
                                                            <option value="{{ $values->id }}" @if($values->id == $lk) selected @endif >{{ $values->layanan }}</option>
                                                            @endforeach
                                                        </select>
                                                    </th>
                                                    <th>
                                                        ...
                                                        @endif
                                                        <a href="{{ URL::to('hapus-booking-layanan/'.$data->id.'/'.$lk) }}" class="btn btn-danger">Hapus</a>
                                                    </th>
                                                </tr>
                                                @endforeach
                                            </table>
