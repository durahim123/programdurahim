                        ...
                        <div class="row">
                            ...
                            <div class="shop-item col-lg-6 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image">
                                            <a href="{{ URL::to('detail-data-treatment/'.$value->id) }}">
                                                <img src="{{ asset('uploads/layanan/'.$value->gambar) }}" alt="">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="lower-content">
                                        <h4 class="name"><a href="{{ URL::to('detail-data-treatment/'.$value->id) }}">{{ $value->layanan }}</a></h4>
                                        <div class="price">Rp {{ number_format($value->harga) }}</div>
                                        <a href="{{ URL::to('detail-data-treatment/'.$value->id) }}" class="theme-btn add-to-cart">Detail</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
            ...
            <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                <aside class="sidebar">
                    ...
                    <div class="sidebar-widget search-box">
                        <form method="get" action="{{ URL::to('data-treatment') }}">
                            <div class="form-group">
                                <input type="search" name="layanan" value="" placeholder="Search....." required="">
                    ...
                    <div class="sidebar-widget category-list">
                        ...
                        <ul class="cat-list">
                        <li><a href="#" class="filter-category" data-kategori="Perawatan">Perawatan</a></li>
                        <li><a href="#" class="filter-category" data-kategori="Estetika">Estetika</a></li>
                        ...
                        $('#layanan-list .row').append(`
                            <div class="shop-item col-lg-6 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image">
                                            <a href="/detail-data-treatment/${layanan.id}">
                                                <img src="/uploads/layanan/${layanan.gambar}" alt="">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="lower-content">
                                        <h4 class="name"><a href="/detail-data-treatment/${layanan.id}">${layanan.layanan}</a></h4>
                                        <div class="price">Rp ${Number(layanan.harga).toLocaleString()}</div>
                                        <a href="/detail-data-treatment/${layanan.id}" class="theme-btn add-to-cart">Detail</a>
                                    </div>
                                </div>
                            </div>
                        `);
