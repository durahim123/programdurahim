            ...
            <div class="nk-block nk-block-lg">
                ...
                <div class="card card-bordered card-preview" style="padding:30px;">
                    <div class="card-inner">
                        ...
                        <h4 class="title nk-block-title">Edit Layanan</h4>
                        <div class="preview-block">
                            <form method="POST" action="{{ URL::to('do-update-layanan/'.$data->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row gy-4">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select name="kategori_layanan" id="" class="form-control">
                                                    ...
                                                    <option value="Estetika" @if($data->kategori_layanan == 'Estetika') selected @endif>Estetika</option>
                                                    <option value="Perawatan" @if($data->kategori_layanan == 'Perawatan') selected @endif>Perawatan</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label" for="default-01">Layanan</label>
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="layanan" placeholder="Input Layanan" value="{{ $data->layanan }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
